    ...
    <div class="article-admin">
        <b-form>
            ...
            <b-row>
                <b-col xs="12">
                    <b-form-group v-show="mode == 'save'" 
                        label="Categoria:" label-for="article-category-id">
                       <b-form-select id="article-category-id"
            ...
            <b-row>
                <b-col xs="12">
                    <b-form-group v-show="mode == 'save'" 
                        label="Autor:" label-for="article-user-id">
        ...
        <b-pagination size="md" v-model="page" :total-rows="count" :per-page="limit" />    </div>
</template>
